                        ...
                        <span
                          ...
                          onClick={() => {
                            modalState.setState({
                              ...
                              modalInfo: {
                                type: "delete-confirm",
                                title: `You are about to <strong><span class="underline">force delete</span> user ${item?.first_name} ${item?.last_name}</strong>. Do you wish to proceed? This action cannot be undone.`,
                                id: "delete-user",
                                item: item,
                                mutateUrl: `${process.env.NEXT_PUBLIC_API_URL}/api/users?${queryParams}`,
                                endpoint: `${process.env.NEXT_PUBLIC_API_URL}/api/users/${item?.id}/delete`,
                              },
                            });
                          }}
                        >
